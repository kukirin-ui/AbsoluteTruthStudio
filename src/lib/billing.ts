...
export const PLANS: PlanDef[] = [
  ...
  },
  {
    ...
    why: "For builders shipping real products. Pro raises the tier ceiling to a few levels below Premium, so you feel the top of the frontier — dial each agent up to that ceiling or down to move faster. Power the models with credits or your own keys, and combine anything with no cap on what you build.",
  ...
  },
  {
    ...
    features: [
      ...
      "Power with credits or BYOK — any model you own",

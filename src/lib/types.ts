...
/** Keyed by the specific agent's catalog id (e.g. "claude", "mistral") — NOT
 * by seat. This is deliberate: memory must stay bound to the agent itself, so
 * swapping which agent sits a seat never leaks one agent's saved memory into
 * another. */

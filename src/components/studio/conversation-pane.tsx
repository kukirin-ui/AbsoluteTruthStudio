  ...
  return (
    ...
    >
      <input
        ...
        type="file"
        className="sr-only"
        accept="image/jpeg,image/png,image/webp,image/gif,.jpg,.jpeg,.png,.webp,.gif,video/mp4,video/quicktime,video/webm,.mp4,.mov,.webm,.txt,.md,.json,.ts,.tsx,.js,.jsx,.css,.html,.svg,.csv,.zip,application/zip,application/x-zip-compressed,.pdf,application/pdf"
        multiple
        disabled={attachBusy}

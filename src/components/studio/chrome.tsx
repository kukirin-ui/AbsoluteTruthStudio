...
import { readOwner, unlockOwner } from "@/lib/owner";
...
export function HeaderBar({
  ...
  plan: PlanId;
  /** Live meter credit display or local mock — never invent Premium/bypass. */
  creditsRemaining?: number | string;
  /** True when user has any BYOK credential meta (from meter or /api/byok). */
  hasByok?: boolean;
  onOpenPlans: () => void;
  onOpenByok?: () => void;
  onOpenPlugins: () => void;

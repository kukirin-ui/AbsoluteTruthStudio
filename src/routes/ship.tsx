...
const KEYS = [
  ...
  },
  {
    ...
    note: "Optional, owner-only. Pin the exact model per provider — the update-any-day lever. Visitors are still clamped to their plan ceiling.",
  },
  {
    key: "OWNER_CODE",
  ...
  return (
    <SiteShell title="Ship the studio" kicker="Web · PWA · Play">
      ...
      <p>
        ...
        keep it one-click; BYOK runs at the visitor's own cost, still inside their plan's model ceiling.
      </p>
      ...
      <p>
        ...
        Premium through Stripe. Their own keys (BYOK) pay for calls but do not raise the plan ceiling. What each side
        sees is separated automatically — you get the full studio, visitors get exactly what their plan allows.
      </p>
